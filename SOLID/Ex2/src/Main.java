...
public class Main {
    public static void main(String[] args) {
        ...
        CheckoutCalculator calculator = new CheckoutCalculator(taxPolicy, discountPolicy);
        InvoiceFormatter formatter = new InvoiceFormatter();
        CafeteriaSystem sys = new CafeteriaSystem(store, printer, calculator, formatter);
